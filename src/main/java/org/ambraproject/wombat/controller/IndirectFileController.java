...
public class IndirectFileController extends WombatController {
  ...
  @RequestMapping(name = "repoObject", value = "{site}/indirect/{key}")
  ...
  @RequestMapping(name = "versionedRepoObject", value = "{site}/indirect/{key}/{version}")
  public void serve(HttpServletResponse response,
                    HttpServletRequest request,
                    @SiteParam Site site,
                    @PathVariable("key") String key,
  ...
  @RequestMapping(name = "repoObjectUsingPublicUrl", value = "{site}/s/file")
