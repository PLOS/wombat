...
<#list hostedData.css_sources as css_source>
    <link rel="stylesheet" type="text/css" href="http://sfo-cms-devbox01.int.plos.org:8080/repo/objects/plive-test?key=${css_source}"/>
</#list>
