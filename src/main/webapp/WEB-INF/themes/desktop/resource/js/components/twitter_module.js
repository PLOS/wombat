  ...
  $.fn.twitter = function (doi) {
   ...
   /* function validateDOI(doi) {
    ...
    /*this.displayTweetsArticleSidebar = function (doi) {
     ...
     /*where to trigger showtweetssidebar */
    ...
    function enableTwitterStream(somedata) {
      var dataPrefix,
        minDisplayTweets = 2,
        calcDisplayTweets = 4;
      var getTweets = new $.fn.getTweetsArticleSidebar(doi, callback);
      function dataPass(i) {
      ...
      for (var i=minDisplayTweets; i <= calcDisplayTweets; i++){
        dataPass(i);
    ...
    var showTweetsArticleSidebar = function (almTweetData) {
      ...
      var  totalTweets, maxDisplayTweets;
      maxDisplayTweets = 5;
