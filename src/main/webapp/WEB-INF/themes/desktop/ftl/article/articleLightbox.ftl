    ...
    <div class="img-container">
      ...
      <aside id="figures-list">
        ...
        <div class="change-img" data-doi="<%= figure.getAttribute('data-doi') %>">
          <img class="aside-figure" src="<@siteLink handlerName="assetFile" queryParameters={"type": "inline"}/>&id=<%= figure.getAttribute('data-doi') %>" />
        </div>
        <% }) %>
...
<script id="image-context-template" type="text/template">
  ...
  <div id="download-buttons">
    <h3>Download:</h3>
    <div class="item">
      <a href="<@siteLink handlerName="assetFile" queryParameters={"type": "original", "download": ""}/>&id=<%= doi %>" title="original image">
        <span class="download-btn">TIFF</span>
      </a>
      <span class="file-size"><%= fileSizes.original %></span>
    </div>
    <div class="item">
      <a href="<@siteLink handlerName="assetFile" queryParameters={"type": "large", "download": ""}/>&id=<%= doi %>" title="large image">
