<#include 'subjectAreaInserts.ftl' />
...
<div class="subject-areas-container">
  ...
  <ul id="subjectList">
    <#list categoryTerms as categoryTerm>
      ...
      <li>
        <a class="taxo-term" title="Search for articles about ${categoryTerm}" href='${baseUrl}search/advanced?unformattedQuery=subject%3A%22${categoryTerm?url}%22'>${categoryTerm}</a>
