  ...
  <article class="ambra-form">
    ...
    <form id="emailThisArticleForm" class="form-default" name="emailThisArticle" action="<@siteLink path='article/email'/>" method="post">
      ...
      <fieldset>
       ...
       </li><li><label class="form-label" id="emailAddressLabel" for="emailAddress">
       ...
       </li><li><label class="form-label" id="senderNameLabel" for="senderName">
       ...
       </li><li><label class="form-label" id="noteLabel" for="note">
       ...
       </li><li><label class="form-label">Text verification:</label>
